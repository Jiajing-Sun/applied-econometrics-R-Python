...
macro <- macro[macro$year>=1978 & macro$year<=2024 & macro$gdp_constant_2015_usd>0, ]
...
m10 <- Arima(ts_growth, order=c(1, 0, 0), method="ML")
m11 <- Arima(ts_growth, order=c(1, 0, 1), method="ML")
m21 <- Arima(ts_growth, order=c(2, 0, 1), method="ML")
