...
# 代码框 1: book_chapters/ch08_dependent_errors.tex:105 / ch08_dependent_errors_1
import numpy as np, pandas as pd
import statsmodels.formula.api as smf
from pathlib import Path
data_path = (Path("Chapter08_Regression_analysis_with_dependent_error_terms_ch_reg_dep_error")
             / "results" / "python_chapter08_acs_cluster_analysis_data.csv")
...
# 代码框 2: book_chapters/ch08_dependent_errors.tex:592 / ch08_survey_py
import statsmodels.formula.api as smf
import numpy as np
...
m_wls = smf.wls("income ~ educ + age + urban",
                ...
                cov_type="HC1")
print(m_wls.summary().tables[1])   # coef、std err、z、P>|z|、95% CI（HC1 默认正态近似）
